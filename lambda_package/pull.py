...
def update_cell(gym_data):
    ...
    print("Wooden Added Time: " + wooden_time)
    print("BFit Added Time: " + bfit_time)
    print("Wooden Added Occupancy: " + wooden_new_occupancy)
    print("BFit Added Occupancy: " + bfit_new_occupancy)
